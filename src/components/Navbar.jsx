...
export const Navbar = () => {
  return (
    <div className="fixed z-[999] w-full px-20 py-8 flex justify-between bg-blur">
      <div className="logo">
        <svg
          width="52"
          height="58"
      ...
      <div className="links pt-5 flex gap-8">
        {["Services", "Our Work", "About Us", "Insights", "Designs"].map(
          (item, index) => (
            <a
              key={index}
